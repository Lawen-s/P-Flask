from flask import Flask, render_template, request, redirect #render_templated으로 html파일 렌더링
...
def register():
  if request.method == 'GET':
    ...
    print(password) # 들어오는지 확인해볼 수 있다.
...
if __name__ == "__main__" :
  ...
  # 여러가지 쌓아져있던 동작들을 Commit을 해주어야 데이터베이스에 반영됨, 이러한 단위들은 트렌젝션이라고 함.
  app.config['SQLALCHEMY_TRACK_MODIFICATIONS'] = False # True하면 warning메시지 유발,
